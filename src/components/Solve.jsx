    ...
    const randomScramble = () => {
        switch (subset) {
            case '3x3x3':
                ...
                break;
            case 'ZBLL':
                setScramble(zbllScrambles[Math.floor(Math.random() * zbllScrambles.length)]);
                break;
            case 'ZBLS':
                setScramble(zblsScrambles[Math.floor(Math.random() * zblsScrambles.length)]);
                break;
        }
    };

    const handleNewScramble = (e) => {
        e.stopPropagation();
        randomScramble();
    };
